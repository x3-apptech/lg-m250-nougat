...
EXTERN(void) jpeg_buffer_src JPP((j_decompress_ptr cinfo, const JOCTET * buff_addr, size_t buff_size));
// LGE_UPDATE_E [kkyungho.lee@lge.com] 2013-01-15, soft MJPEG decoder
