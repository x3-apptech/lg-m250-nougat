...
libext2_profile_system_static_libraries := libc
...
LOCAL_MODULE := libext2_profile
LOCAL_MODULE_TAGS := optional
LOCAL_SYSTEM_STATIC_LIBRARIES := $(libext2_profile_system_static_libraries)
LICAL_STATIC_LIBRARIES := $(libext2_profile_static_libraries)
LOCAL_C_INCLUDES := $(libext2_profile_c_includes)
LOCAL_CFLAGS := $(libext2_profile_cflags)
