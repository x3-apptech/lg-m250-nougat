...
class Inet6AddressImpl implements InetAddressImpl {
    ...
    private static InetAddress[] lookupHostByName(String host, int netId)
        ...
        /* 2013-12-27, wonwoo.kim@lge.com LGP_DATA_DATA_STALL_DNS_QUERY_VZW [START] */
        // "outofcredit.myvzw.com" have to be called by VZW only, so it doesn't need to use FEATURE.
        // The name of URI can be the feature.
        if(!(host.equals("outofcredit.myvzw.com")))
        /* 2013-12-27, wonwoo.kim@lge.com LGP_DATA_DATA_STALL_DNS_QUERY_VZW [END] */
