...
static void lcm_get_params(LCM_PARAMS * params)
{
	...
	params->dsi.vertical_sync_active = 126; //20150824 , 1->2
	...
	params->dsi.PLL_CLOCK = 262;//for 60fps
...
{
    LCM_PRINT("lcm_suspend_for_mfts Start\n");
    ...
    LCM_PRINT("[LCD] lcm_suspend_for_mfts End\n");
}
