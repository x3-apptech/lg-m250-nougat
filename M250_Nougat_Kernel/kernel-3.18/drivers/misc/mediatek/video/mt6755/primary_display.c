...
//extern int lpwg_mfts;  // for LV5 dualization unified touch driver(Tovis panel driver)
extern int lge_get_maker_id(void);
int get_lpwg_mfts(void);
#endif
...
#ifdef CONFIG_LCM_SEND_CMD_IN_VIDEO //original
...
#ifndef CONFIG_LCM_SEND_CMD_IN_VIDEO   //original source
...
#if defined(CONFIG_TUNING_MIPI_CLOCK)
