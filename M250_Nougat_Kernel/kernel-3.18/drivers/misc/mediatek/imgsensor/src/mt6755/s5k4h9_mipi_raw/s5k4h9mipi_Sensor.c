...
#define LOG_2 LOG_INF("preview 1640*1232@30fps,1488Mbps/lane; video 4192*3104@30fps,1260Mbps/lane; capture 3280*2464@30fps,1488Mbps/lane\n")
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .i2c_addr_table = {0x5a, 0xff}, //{0x20, 0x5a,0xff},
...
{{ 3280, 2464,      0,    0, 3280, 2464, 1640,  1232, 0, 0, 1640, 1232,     0,    0, 1640, 1232}, // Preview
 ...
 { 3280, 2464,     16,   16, 3264, 2448,  816,   612, 0, 0,  816,  612,     0,    0,  816,  608}, // hight speed video
 { 3280, 2464,    720, 1024, 2560, 1440, 1280,   720, 0, 0, 1280,  720,     0,    0, 1280,  720}, // slim video
};
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0xF468, 0x0017);//0x001B); //LGE_UPDATE [yonghwan.lym@lge.com] 2016/11/21, Sensor Initial Setting Update
