...
int iBurstReadRegI2C(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16 a_sizeRecvData, u16 i2cId)
{
    ...
    //cam_mutex_lock(&kdCam_i2c_Mutex);
        ...
        buf = dma_alloc_coherent(0, a_sizeRecvData, (dma_addr_t *)&phyAddr, GFP_KERNEL);
...
static int CAMERA_HW_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    /* set I2C clock rate */
    g_pstI2Cclient->timing = 400; //LGE_UPDATE [youmi.jun@lge.com] 2016/09/28, change I2C clock 400KHz
...
static int CAMERA_HW_i2c_probe2(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    /* set I2C clock rate */
    g_pstI2Cclient2->timing = 400; //LGE_UPDATE [youmi.jun@lge.com] 2016/09/28, change I2C clock 400KHz
