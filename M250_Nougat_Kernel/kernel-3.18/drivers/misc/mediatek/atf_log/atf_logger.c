...
extern struct _lge_crash_footprint *crash_footprint;
#endif
...
#ifdef CONFIG_LGE_HANDLE_PANIC
	crash_footprint->atf_buf_addr = (u32)atf_buf_vir_ctl->info.atf_buf_addr;
	crash_footprint->atf_buf_size = (u32)atf_buf_vir_ctl->info.atf_buf_size;
#endif
