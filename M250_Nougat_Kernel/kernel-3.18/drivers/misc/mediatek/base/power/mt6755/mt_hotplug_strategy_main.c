...
void hps_ctxt_reset_stas_nolock(void)
{
	...
	for(i = 0 ; i < MAX_CPU_UP_TIMES ; i++)
		hps_ctxt.up_loads_history[i] = 0;
	...
	for(i = 0 ; i < MAX_CPU_DOWN_TIMES ; i++)
		hps_ctxt.down_loads_history[i] = 0;
	...
	for(i = 0 ; i < MAX_TLP_TIMES ; i++)
		hps_ctxt.tlp_history[i] = 0;
