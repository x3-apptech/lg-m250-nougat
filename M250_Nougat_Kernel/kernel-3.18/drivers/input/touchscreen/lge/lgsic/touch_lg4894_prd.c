...
static int write_test_mode(struct device *dev, u8 type)
{
	...
	if (type == U3_BLU_JITTER_TEST) {
		...
		TOUCH_I("BackLight Off at BLU JITTER (TARGET_MT6735_K6P||CONFIG_LGE_TOUCH_LG4894)\n");
#elif defined(CONFIG_MSM8909_K6P)
		rt4832_lcd_backlight_set_level(0);
		TOUCH_I("BackLight Off at BLU JITTER (CONFIG_MSM8909_K6P)\n");
#endif
		touch_msleep(278);
#if defined(TARGET_MT6735_K6P) || defined(CONFIG_LGE_TOUCH_LG4894)
		mt65xx_leds_brightness_set(6, backlightness);
		TOUCH_I("BackLight On at BLU JITTER (TARGET_MT6735_K6P||CONFIG_LGE_TOUCH_LG4894)\n");
#elif defined(CONFIG_MSM8909_K6P)
		rt4832_lcd_backlight_set_level(backlightness);
		TOUCH_I("BackLight On at BLU JITTER (CONFIG_MSM8909_K6P)\n");
#endif
		}
